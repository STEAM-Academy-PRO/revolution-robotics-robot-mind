...
class TestCommand(unittest.TestCase):
    ...
    def test_header_checksum_includes_payload(self):
        ...
        payload_checksum = binascii.crc_hqx(bytes([1, 2, 3]), 0xFFFF).to_bytes(
            2, byteorder="little"
        )
        ...
        mock_interface = MockInterface(
            [
                ...
                [
                    ...
                    0,
                    0,
                ],  # different header when reading data
        ...
        mock_interface = MockInterface(
            [
                ...
                [
                    ...
                    0,
                    0,
                ],  # read is retried 5 times or until success
                [ResponseStatus.Ok.value, 0, 0xFF, 0xFF, 117, 0, 0],
        ...
        mock_interface = MockInterface(
            [
                ...
                [
                    ...
                    0x0A,
                    0x0B,
                ],  # respond with success, but invalid header
                [ResponseStatus.Ok.value, 2, 0xAF, 0x43, 121, 0x0A, 0x0B],  # respond with success
            ]
        )
        rt = RevvyTransport(mock_interface)
        ...
        mock_interface = MockInterface(
            [
                ...
                [
                    ...
                    0x0A,
                    0x0C,
                ],  # respond with success, but invalid payload
                [ResponseStatus.Ok.value, 2, 0xAF, 0x43, 121, 0x0A, 0x0B],  # respond with success
            ]
        )
        rt = RevvyTransport(mock_interface)
